...
namespace Breb.Cuentas.Migrations
{
    ...
    [Migration("20260903040517_RetencionComoEntidad")]
    partial class RetencionComoEntidad
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Breb.Cuentas.Dominio.Cuenta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Breb.Cuentas.Dominio.MensajeProcesado", b =>
                {
            ...
            modelBuilder.Entity("Breb.Cuentas.Dominio.Retencion", b =>
                {
                    ...
                    b.Property<DateTime?>("LiberadaEn")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal>("MontoUVB")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.HasKey("TransferenciaId");

                    b.HasIndex("CuentaId", "Liberada")
                        .HasFilter("\"Liberada\" = false");

                    b.ToTable("Retenciones");
                });

            modelBuilder.Entity("Breb.Cuentas.Sagas.TransferenciaSagaState", b =>
                {
                    ...
                    b.Property<string>("MotivoCompensacion")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Breb.Cuentas.Dominio.Retencion", b =>
                {
                    b.HasOne("Breb.Cuentas.Dominio.Cuenta", null)
                        .WithMany()
